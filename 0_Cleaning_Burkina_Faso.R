...
# To clean household data from Burkina Faso
# Based on R-Script for Benin (as of 06.09.2022)
# Author: L. Missbach (missbach@mcc-berlin.net)

# Load Data ####

data_0.0   <- read_sav("../0_Data/1_Household Data/2_Burkina Faso/1_Data_Raw/ehcvm_conso_bfa2018.sav") # Consumption

data_0.3   <- read_sav("../0_Data/1_Household Data/2_Burkina Faso/1_Data_Raw/ehcvm_ponderations_bfa2018.sav") # HH-Weights

data_0.5   <- read_sav("../0_Data/1_Household Data/2_Burkina Faso/1_Data_Raw/s00_me_bfa2018.sav") # Control Information
# data_0.6 <- read_sav("../0_Data/1_Household Data/2_Burkina Faso/1_Data_Raw/s00a_co_bfa2018.sav")
# data_0.7 <- read_sav("../0_Data/1_Household Data/2_Burkina Faso/1_Data_Raw/s00b_co_bfa2018.sav")

data_1.1   <- read_sav("../0_Data/1_Household Data/2_Burkina Faso/1_Data_Raw/s01_me_bfa2018.sav") # Household Socio-Demographic Characteristics
# data_1.2 <- read_sav("../0_Data/1_Household Data/2_Burkina Faso/1_Data_Raw/s01_co_bfa2018.sav")
data_2.1   <- read_sav("../0_Data/1_Household Data/2_Burkina Faso/1_Data_Raw/s02_me_bfa2018.sav") # Education
# data_2.2 <- read_sav("../0_Data/1_Household Data/2_Burkina Faso/1_Data_Raw/s02_co_bfa2018.sav")
data_3.1   <- read_sav("../0_Data/1_Household Data/2_Burkina Faso/1_Data_Raw/s03_me_bfa2018.sav") # General Health
# data_3.2 <- read_sav("../0_Data/1_Household Data/2_Burkina Faso/1_Data_Raw/s03_co_bfa2018.sav")
data_4.1   <- read_sav("../0_Data/1_Household Data/2_Burkina Faso/1_Data_Raw/s04_me_bfa2018.sav") # Employment
# data_4.2 <- read_sav("../0_Data/1_Household Data/2_Burkina Faso/1_Data_Raw/s04_co_bfa2018.sav")
data_5.1   <- read_sav("../0_Data/1_Household Data/2_Burkina Faso/1_Data_Raw/s05_me_bfa2018.sav") # Nonjob Revenues
# data_5.2 <- read_sav("../0_Data/1_Household Data/2_Burkina Faso/1_Data_Raw/s05_co_bfa2018.sav")

# data_6   <- read_sav("../0_Data/1_Household Data/2_bfain/1 Data_Raw/s06_me_bfa2018.sav") # Saving and credit

data_7.1   <- read_sav("../0_Data/1_Household Data/2_Burkina Faso/1_Data_Raw/s07a1_me_bfa2018.sav") # Food outside the household
data_7.2   <- read_sav("../0_Data/1_Household Data/2_Burkina Faso/1_Data_Raw/s07a2_me_bfa2018.sav") # Food outside the household
data_7.3   <- read_sav("../0_Data/1_Household Data/2_Burkina Faso/1_Data_Raw/s07b_me_bfa2018.sav") # Food within the household

# data_8.1 <- read_sav("../0_Data/1_Household Data/2_Burkina Faso/1_Data_Raw/s08a_me_bfa2018.sav") # Food security
# data_8.2 <- read_sav("../0_Data/1_Household Data/2_Burkina Faso/1_Data_Raw/s08b1_me_bfa2018.sav")# Food security
# data_8.3 <- read_sav("../0_Data/1_Household Data/2_Burkina Faso/1_Data_Raw/s08b2_me_bfa2018.sav")# Food security

data_9.1   <- read_sav("../0_Data/1_Household Data/2_Burkina Faso/1_Data_Raw/s09a_me_bfa2018.sav") # Nonfood 12 months
data_9.2   <- read_sav("../0_Data/1_Household Data/2_Burkina Faso/1_Data_Raw/s09b_me_bfa2018.sav") # Nonfood 7 days
data_9.3   <- read_sav("../0_Data/1_Household Data/2_Burkina Faso/1_Data_Raw/s09c_me_bfa2018.sav") # Nonfood 30 days
data_9.4   <- read_sav("../0_Data/1_Household Data/2_Burkina Faso/1_Data_Raw/s09d_me_bfa2018.sav") # Nonfood 3 months
data_9.5   <- read_sav("../0_Data/1_Household Data/2_Burkina Faso/1_Data_Raw/s09e_me_bfa2018.sav") # Nonfood 6 months
data_9.6   <- read_sav("../0_Data/1_Household Data/2_Burkina Faso/1_Data_Raw/s09f_me_bfa2018.sav") # Nonfood 12 months

data_11.1  <- read_sav("../0_Data/1_Household Data/2_Burkina Faso/1_Data_Raw/s11_me_bfa2018.sav") # Housing
data_12.1  <- read_sav("../0_Data/1_Household Data/2_Burkina Faso/1_Data_Raw/s12_me_bfa2018.sav") # Assets

data_13.1  <- read_sav("../0_Data/1_Household Data/2_Burkina Faso/1_Data_Raw/s13a_1_me_bfa2018.sav") # Transfers received (remittances)
data_13.2  <- read_sav("../0_Data/1_Household Data/2_Burkina Faso/1_Data_Raw/s13a_2_me_bfa2018.sav") # Transfers sent (remittances)
data_15.1  <- read_sav("../0_Data/1_Household Data/2_Burkina Faso/1_Data_Raw/s15_me_bfa2018.sav") # Safety nets
...
Cooking.Code <- distinct(data_11.1.1, Cooking_Fuel)%>%
  ...
  write_csv(., "../0_Data/1_Household Data/2_Burkina Faso/2_Codes/Cooking.Code.csv")
...
write_csv(household_information, "../0_Data/1_Household Data/2_Burkina Faso/1_Data_Clean/household_information_Burkina Faso.csv")
...
write_csv(expenditures_df_2, "../0_Data/1_Household Data/2_Burkina Faso/1_Data_Clean/expenditures_items_Burkina Faso.csv")
...
write_csv(data_12.1.1, "../0_Data/1_Household Data/2_Burkina Faso/1_Data_Clean/appliances_0_1_Burkina Faso.csv")
...
# write.xlsx(Item.Joint.1, "../0_Data/1_Household Data/2_Burkina_Faso/3_Matching_Tables/Item_Code_Description_Burkina_Faso.xlsx")
...
Education.Code <- stack(attr(data_2.1$s02q29, 'labels'))%>%
  ...
  write_csv(., "../0_Data/1_Household Data/2_Burkina Faso/2_Codes/Education.Code.csv")
Province.Code <- stack(attr(data_0.5$s00q01, 'labels'))%>%
  rename(province = values, Province = ind)%>%
  write_csv(., "../0_Data/1_Household Data/2_Burkina Faso/2_Codes/Province.Code.csv")
District.Code <- stack(attr(data_0.5$s00q02, 'labels'))%>%
  rename(district = values, District = ind)%>%
  write_csv(., "../0_Data/1_Household Data/2_Burkina Faso/2_Codes/District.Code.csv")
Gender.Code <- stack(attr(data_1.1$s01q01, 'labels'))%>%
  rename(sex_hhh = values, Gender = ind)%>%
  write_csv(., "../0_Data/1_Household Data/2_Burkina Faso/2_Codes/Gender.Code.csv")
Ethnicity.Code <- stack(attr(data_1.1$s01q16, 'labels'))%>%
  rename(ethnicity = values, Ethnicity = ind)%>%
  write_csv(., "../0_Data/1_Household Data/2_Burkina Faso/2_Codes/Ethnicity.Code.csv")
Nationality.Code <- stack(attr(data_1.1$s01q15, 'labels'))%>%
  rename(nationality = values, Nationality = ind)%>%
  write_csv(., "../0_Data/1_Household Data/2_Burkina Faso/2_Codes/Nationality.Code.csv")
Religion.Code <- stack(attr(data_1.1$s01q14, 'labels'))%>%
  rename(religion = values, Religion = ind)%>%
  write_csv(., "../0_Data/1_Household Data/2_Burkina Faso/2_Codes/Religion.Code.csv")
Lighting.Code <- stack(attr(data_11.1$s11q38, 'labels'))%>%
  rename(lighting_fuel = values, Lighting_Fuel = ind)%>%
  write_csv(., "../0_Data/1_Household Data/2_Burkina Faso/2_Codes/Lighting.Code.csv")
Toilet.Code <- stack(attr(data_11.1$s11q55, 'labels'))%>%
  rename(toilet = values, TLT = ind)%>%
  write_csv(., "../0_Data/1_Household Data/2_Burkina Faso/2_Codes/Toilet.Code.csv")
...
write_csv(Water.Code, "../0_Data/1_Household Data/2_Burkina Faso/2_Codes/Water.Code.csv")

Industry.Code <- stack(attr(data_4.1$s04q30c, 'labels'))%>%
  rename(ind_hhh = values, Industry = ind)%>%
  write_csv(., "../0_Data/1_Household Data/2_Burkina Faso/2_Codes/Industry.Code.csv")
