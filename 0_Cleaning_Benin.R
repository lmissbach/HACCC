...
# To clean household data from Benin
# Author: L. Missbach (missbach@mcc-berlin.net)

# Load Data ####

data_0.0 <- read_dta("../0_Data/1_Household Data/2_Benin/1_Data_Raw/ehcvm_conso_ben2018.dta") # Consumption
# data_0.1 <- read_dta("../0_Data/1_Household Data/2_Benin/1_Data_Raw/ehcvm_individu_ben2018.dta") # Individuals
# data_0.2 <- read_dta("../0_Data/1_Household Data/2_Benin/1_Data_Raw/ehcvm_menage_ben2018.dta") # Household
data_0.3 <- read_dta("../0_Data/1_Household Data/2_Benin/1_Data_Raw/ehcvm_ponderations_ben2018.dta") # HH-Weights
# data_0.4 <- read_dta("../0_Data/1_Household Data/2_Benin/1_Data_Raw/ehcvm_welfare_ben2018.dta") # Welfare
data_0.5 <- read_dta("../0_Data/1_Household Data/2_Benin/1_Data_Raw/s00_me_ben2018.dta") # Control Information
# data_0.6 <- read_dta("../0_Data/1_Household Data/2_Benin/1_Data_Raw/s00a_co_ben2018.dta")
# data_0.7 <- read_dta("../0_Data/1_Household Data/2_Benin/1_Data_Raw/s00b_co_ben2018.dta")

data_1.1 <- read_dta("../0_Data/1_Household Data/2_Benin/1_Data_Raw/s01_me_ben2018.dta") # Household Socio-Demographic Characteristics
# data_1.2 <- read_dta("../0_Data/1_Household Data/2_Benin/1_Data_Raw/s01_co_ben2018.dta")
data_2.1 <- read_dta("../0_Data/1_Household Data/2_Benin/1_Data_Raw/s02_me_ben2018.dta") # Education
# data_2.2 <- read_dta("../0_Data/1_Household Data/2_Benin/1_Data_Raw/s02_co_ben2018.dta")
data_3.1 <- read_dta("../0_Data/1_Household Data/2_Benin/1_Data_Raw/s03_me_ben2018.dta") # General Health
# data_3.2 <- read_dta("../0_Data/1_Household Data/2_Benin/1_Data_Raw/s03_co_ben2018.dta")
data_4.1 <- read_dta("../0_Data/1_Household Data/2_Benin/1_Data_Raw/s04_me_ben2018.dta") # Employment
# data_4.2 <- read_dta("../0_Data/1_Household Data/2_Benin/1_Data_Raw/s04_co_ben2018.dta")
data_5.1 <- read_dta("../0_Data/1_Household Data/2_Benin/1_Data_Raw/s05_me_ben2018.dta") # Nonjob Revenues
# data_5.2 <- read_dta("../0_Data/1_Household Data/2_Benin/1_Data_Raw/s05_co_ben2018.dta")

# data_6 <- read_dta("../0_Data/1_Household Data/2_Benin/1_Data_Raw/s06_me_ben2018.dta") # Saving and credit

data_7.1 <- read_dta("../0_Data/1_Household Data/2_Benin/1_Data_Raw/s07a1_me_ben2018.dta") # Food outside the household
data_7.2 <- read_dta("../0_Data/1_Household Data/2_Benin/1_Data_Raw/s07a2_me_ben2018.dta") # Food outside the household
data_7.3 <- read_dta("../0_Data/1_Household Data/2_Benin/1_Data_Raw/s07b_me_ben2018.dta") # Food within the household

# data_8.1 <- read_dta("../0_Data/1_Household Data/2_Benin/1_Data_Raw/s08a_me_ben2018.dta") # Food security
# data_8.2 <- read_dta("../0_Data/1_Household Data/2_Benin/1_Data_Raw/s08b1_me_ben2018.dta")# Food security
# data_8.3 <- read_dta("../0_Data/1_Household Data/2_Benin/1_Data_Raw/s08b2_me_ben2018.dta")# Food security

data_9.1 <- read_dta("../0_Data/1_Household Data/2_Benin/1_Data_Raw/s09a_me_ben2018.dta") # Nonfood 12 months
data_9.2 <- read_dta("../0_Data/1_Household Data/2_Benin/1_Data_Raw/s09b_me_ben2018.dta") # Nonfood 7 days
data_9.3 <- read_dta("../0_Data/1_Household Data/2_Benin/1_Data_Raw/s09c_me_ben2018.dta") # Nonfood 30 days
data_9.4 <- read_dta("../0_Data/1_Household Data/2_Benin/1_Data_Raw/s09d_me_ben2018.dta") # Nonfood 3 months
data_9.5 <- read_dta("../0_Data/1_Household Data/2_Benin/1_Data_Raw/s09e_me_ben2018.dta") # Nonfood 6 months
data_9.6 <- read_dta("../0_Data/1_Household Data/2_Benin/1_Data_Raw/s09f_me_ben2018.dta") # Nonfood 12 months

data_11.1 <- read_dta("../0_Data/1_Household Data/2_Benin/1_Data_Raw/s11_me_ben2018.dta") # Housing
data_12.1 <- read_dta("../0_Data/1_Household Data/2_Benin/1_Data_Raw/s12_me_ben2018.dta") # Assets

data_13.1 <- read_dta("../0_Data/1_Household Data/2_Benin/1_Data_Raw/s13a_1_me_ben2018.dta") # Transfers received (remittances)
data_13.2 <- read_dta("../0_Data/1_Household Data/2_Benin/1_Data_Raw/s13a_2_me_ben2018.dta") # Transfers sent (remittances)
data_15.1 <- read_dta("../0_Data/1_Household Data/2_Benin/1_Data_Raw/s15_me_ben2018.dta") # Safety nets
...
data_1.1.1 <- data_1.1 %>%
  ...
  mutate(ethnicity = ifelse(is.na(ethnicity),54,ethnicity))
...
Cooking.Code <- distinct(data_11.1.1, Cooking_Fuel)%>%
  ...
  write_csv(., "../0_Data/1_Household Data/2_Benin/2_Codes/Cooking.Code.csv")
...
write_csv(household_information, "../0_Data/1_Household Data/2_Benin/1_Data_Clean/household_information_Benin.csv")
...
write_csv(expenditures_df_2, "../0_Data/1_Household Data/2_Benin/1_Data_Clean/expenditures_items_Benin.csv")
...
write_csv(data_12.1.1, "../0_Data/1_Household Data/2_Benin/1_Data_Clean/appliances_0_1_Benin.csv")
...
# write.xlsx(Item.Joint.1, "../0_Data/1_Household Data/2_Benin/3_Matching_Tables/Item_Code_Description_Benin.xlsx")
...
Industry.Code <- stack(attr(data_4.1$s04q30c, 'labels'))%>%
  ...
  write_csv(., "../0_Data/1_Household Data/2_Benin/2_Codes/Industry.Code.csv")
