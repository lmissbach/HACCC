...
for(i in Country.Set){
  ...
  etable(model_2.1.1.1, dict = dict_latex, tex = TRUE, file = sprintf("../1_Carbon_Pricing_Incidence/3_Analyses/1_LAC_2021/6_App/Latin-America-Paper/Tables/Table_2_OLS/Table_OLS_%s.tex", i),
         ...
         title = sprintf("OLS-Regression Coefficients for %s", i),  label = sprintf("tab:OLS_%s",i), adjustbox = "width = 1\\textwidth, max height = 1\\textheight, center", placement = "htbp!",
...
for(i in Country.Set){
  ...
  etable(model_2.1.2.1, dict = dict_latex, tex = TRUE, file = sprintf("../1_Carbon_Pricing_Incidence/3_Analyses/1_LAC_2021/6_App/Latin-America-Paper/Tables/Table_4_Logit_Burden/Table_Logit_Burden_%s.tex", i),
         ...
         title = sprintf("Logit-Model Coefficients Hardship Cases in %s", i),  label = sprintf("tab:Logit_1_%s",i), adjustbox = "width = 1\\textwidth, max height = 1\\textheight, center", placement = "htbp!",
         notes = c("\\medskip \\textit{Note:}",
...
for(i in Country.Set){
  ...
  etable(model_2.2.2.1, dict = dict_latex, tex = TRUE, file = sprintf("../1_Carbon_Pricing_Incidence/3_Analyses/1_LAC_2021/6_App/Latin-America-Paper/Tables/Table_5_Logit_Transfers_Burden/Table_Logit_Transfers_Burden_%s.tex", i),
         digits = 3, replace = TRUE, fitstat = c("n", "cor2"), style.tex = tex.style, se.row = TRUE, tpt = TRUE,
         title = sprintf("Logit-Model Coefficients Hardship Cases and no Access to Transfers in %s", i),  label = sprintf("tab:Logit_2_%s",i), adjustbox = "width = 1\\textwidth, max height = 1\\textheight, center", placement = "htbp!",
         notes = c("\\medskip \\textit{Note:}",
