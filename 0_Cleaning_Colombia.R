...
# This script is designed to clean the Colombian Household Data

data_colombia_clean <- read_dta("../0_Data/1_Household Data/3_Colombia/1_Data_Clean/LAC_Clean/COL_ENPH_2016-2017.dta")
...
appliances <- data_hogares %>%
  ...
  rename(washing_machine.01 = S4, refrigerator.01 = S5, stove.e.01 = S7, stove.g.01 = S8, microwave.01 = S9, 
         heater.01 = S10, ac.01 = S12, fan.01 = S13, vacuum.01 = S11, tv.01a = S15, tv.01b = S16, computer.01a = S25,
