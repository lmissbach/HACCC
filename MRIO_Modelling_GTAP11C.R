...
CO2_R <- read_csv(sprintf("R:/MSA/datasets/GTAP/gtap11_data/GTAP11C_GTAP_%s_65x160/CO2_GTAP_11_%s_re.csv", year_0, year_0), col_names = FALSE, show_col_types = FALSE)
Y_0   <- np$load(sprintf("R:/MSA/datasets/GTAP/gtap11_data/GTAP11C_GTAP_%s_65x160/GTAP11_%s_re_y.npy", year_0, year_0))
Z_0   <- np$load(sprintf("R:/MSA/datasets/GTAP/gtap11_data/GTAP11C_GTAP_%s_65x160/GTAP11_%s_re_z.npy", year_0, year_0))
...
if(year_0 == "2017"){
  L_2 <- read_csv("../0_Data/2_IO Data/GTAP_11_MRIO/GTAP11C_2017/L_2.csv")%>%
    arrange(Country_B, Sector_B)
  
  L2_EU <- read_csv("../0_Data/2_IO Data/GTAP_11_MRIO/GTAP11C_2017/EU_ETS_Carbon_Intensities_L.csv")%>%
    arrange(Country_B, Sector_B)
  
  # L_2_NON <- read_csv("L_2_NON.csv")%>%
  #   arrange(Country_B, Sector_B)
  
  national_carbon_intensities             <- read_csv("../0_Data/2_IO Data/GTAP_11_MRIO/GTAP11C_2017/National_Carbon_Intensities_L.csv")
  transport_national_carbon_intensities   <- read_csv("../0_Data/2_IO Data/GTAP_11_MRIO/GTAP11C_2017/Transport_National_Carbon_Intensities_L.csv")
  electricity_national_carbon_intensities <- read_csv("../0_Data/2_IO Data/GTAP_11_MRIO/GTAP11C_2017/Electricity_National_Carbon_Intensities_L.csv")
  
  EU_transport_carbon_intensities <- read_csv("../0_Data/2_IO Data/GTAP_11_MRIO/GTAP11C_2017/EU_ETS_Transport_Carbon_Intensities_L.csv")
  
  # national_non_carbon_intensities         <- read_csv("National_NON_Carbon_Intensities_L.csv")
  gas_national_carbon_intensities         <- read_csv("../0_Data/2_IO Data/GTAP_11_MRIO/GTAP11C_2017/Gas_National_Carbon_Intensities_L.csv")
  ...
  cons_dom <- read_delim("R:/MSA/datasets/GTAP/gtap11_data/GTAP11C_GTAP_2017_65x160/VDPB.csv", ",", escape_double = FALSE, trim_ws = TRUE, col_names = FALSE)
  cons_int <- read_delim("R:/MSA/datasets/GTAP/gtap11_data/GTAP11C_GTAP_2017_65x160/VMPB.csv", ",", escape_double = FALSE, trim_ws = TRUE, col_names = FALSE)
  
  # Purchase prices
  cons_dom_P <- read_delim("R:/MSA/datasets/GTAP/gtap11_data/GTAP11C_GTAP_2017_65x160/VDPP.csv", ",", escape_double = FALSE, trim_ws = TRUE, col_names = FALSE)
  cons_int_P <- read_delim("R:/MSA/datasets/GTAP/gtap11_data/GTAP11C_GTAP_2017_65x160/VMPP.csv", ",", escape_double = FALSE, trim_ws = TRUE, col_names = FALSE)
  
  CO2_dir_imp <- read_delim("R:/MSA/datasets/GTAP/gtap11_data/GTAP11C_GTAP_2017_65x160/MMP.csv", ",", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)%>%
    bind_rows(data.frame(X2 = "ita", X1 = "coa", X3 = 0))
  CO2_dir_dom <- read_delim("R:/MSA/datasets/GTAP/gtap11_data/GTAP11C_GTAP_2017_65x160/MDP.csv", ",", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)%>%
    bind_rows(data.frame(X2 = "ita", X1 = "coa", X3 = 0))
...
# 
# if(year_0 != "2017"){write_csv(L_2, sprintf("../0_Data/2_IO Data/GTAP_11_MRIO/GTAP11C_%s/L_2.csv", year_0))}
# # write_csv(L_2, "../0_Data/2_IO Data/GTAP_11_MRIO/GTAP11C_2017/L_2.csv")
...
#  }
#  
#  if(year_0 != "2017"){write_csv(national_carbon_intensities, sprintf("../0_Data/2_IO Data/GTAP_11_MRIO/GTAP11C_%s/National_Carbon_Intensities_L.csv", year_0))}
#  if(year_0 == "2017"){write_csv(national_carbon_intensities, "../0_Data/2_IO Data/GTAP_11_MRIO/GTAP11C_2017/National_Carbon_Intensities_L.csv")}
...
#           Country_B = as.numeric(Country_B))
#  
#  if(year_0 != "2017"){write_csv(L_2_EU, sprintf("../0_Data/2_IO Data/GTAP_11_MRIO/GTAP11C_%s/EU_ETS_Carbon_Intensities_L.csv", year_0))}
#  if(year_0 == "2017"){write_csv(L_2_EU, "../0_Data/2_IO Data/GTAP_11_MRIO/GTAP11C_2017/EU_ETS_Carbon_Intensities_L.csv")}
...
#   
#   }
#    if(year_0 != "2017"){write_csv(transport_national_carbon_intensities, sprintf("../0_Data/2_IO Data/GTAP_11_MRIO/GTAP11C_%s/Transport_National_Carbon_Intensities_L.csv", year_0))}
#    if(year_0 == "2017"){write_csv(transport_national_carbon_intensities, "../0_Data/2_IO Data/GTAP_11_MRIO/GTAP11C_2017/Transport_National_Carbon_Intensities_L.csv")}
...
#           Country_B = as.numeric(Country_B))
#  
#  if(year_0 != "2017"){write_csv(L_3_EU, sprintf("../0_Data/2_IO Data/GTAP_11_MRIO/GTAP11C_%s/EU_ETS_Transport_Carbon_Intensities_L.csv", year_0))}
#  if(year_0 == "2017"){write_csv(L_3_EU, "../0_Data/2_IO Data/GTAP_11_MRIO/GTAP11C_2017/EU_ETS_Transport_Carbon_Intensities_L.csv")}
...
#  }
#  
#  if(year_0 != "2017"){write_csv(electricity_national_carbon_intensities, sprintf("../0_Data/2_IO Data/GTAP_11_MRIO/GTAP11C_%s/Electricity_National_Carbon_Intensities_L.csv", year_0))}
#  if(year_0 == "2017"){write_csv(electricity_national_carbon_intensities, "../0_Data/2_IO Data/GTAP_11_MRIO/GTAP11C_2017/Electricity_National_Carbon_Intensities_L.csv")}
...
#  
#  }
#  if(year_0 != "2017"){write_csv(gas_national_carbon_intensities, sprintf("../0_Data/2_IO Data/GTAP_11_MRIO/GTAP11C_%s/Gas_National_Carbon_Intensities_L.csv", year_0))}
#  if(year_0 == "2017"){write_csv(gas_national_carbon_intensities, "../0_Data/2_IO Data/GTAP_11_MRIO/GTAP11C_2017/Gas_National_Carbon_Intensities_L.csv")}
...
cons_dom_P_1 <- cons_dom_P %>%
  rename(Cons_Dom_P = X3)
...
cons_int_P_1 <- cons_int_P %>%
  rename(Cons_Int_P = X3)
...
cons_tot_P <- left_join(cons_dom_P_1, cons_int_P_1, by = c("X1", "X2"))%>%
  mutate(Cons_Tot_P = Cons_Dom_P + Cons_Int_P)%>%
  rename(Sector = X1, Country = X2)
...
cons_tot_P_0 <- select(cons_tot_P, Sector, Cons_Tot_P, Country)%>%
  left_join(regions, by = "Country")%>%
  left_join(sectors, by = "Sector")%>%
  # mutate(Sector = as.numeric(Sector))%>%
  filter(country_number == Country_Number)%>%
...
rm(cons_dom_1, cons_int_1, cons_dom_P_1, cons_int_P_1)
...
df_final <- expand.grid(GTAP = c(1:65))%>%
  ...
  left_join(cons_tot_P_0, by = c("GTAP" = "sector_number"))%>%
  ...
  rename(Total_HH_Consumption_MUSD = Cons_Tot, 
         Total_HH_Consumption_MUSD_P = Cons_Tot_P,
...
df_final_out <- df_final %>%
  select(GTAP, CO2_Mt, CO2_Mt_within, CO2_Mt_EU, CO2_Mt_Electricity, CO2_Mt_Transport, CO2_Mt_Transport_EU, CO2_Mt_Gas,
         ...
         Total_HH_Consumption_MUSD, Total_HH_Consumption_MUSD_P)
...
if(year_0 != "2017"){write.xlsx(list_0, sprintf("../0_Data/2_IO Data/GTAP_11_MRIO/GTAP11C_%s/Carbon_Intensities_Full_All_Gas_EU_%s.xlsx", year_0, year_0), append = TRUE, colNames = TRUE)}
if(year_0 == "2017"){write.xlsx(list_0, "../0_Data/2_IO Data/GTAP_11_MRIO/GTAP11C_2017/Carbon_Intensities_Full_All_Gas_EU.xlsx", append = TRUE, colNames = TRUE)}
