...
personas_0  <- read_sav("../0_Data/1_Household Data/3_Costa Rica/1_Data_Raw/Enigh2018_CreaVar_ Personas_PUBLICA.sav")
hogar_0     <- read_sav("../0_Data/1_Household Data/3_Costa Rica/1_Data_Raw/Enigh2018_CreaVar_ Hogar_PUBLICA.sav")
gastos_0    <- read_sav("../0_Data/1_Household Data/3_Costa Rica/1_Data_Raw/Enigh2018_Gasto_Publica.sav")
