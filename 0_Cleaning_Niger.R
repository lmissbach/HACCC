...
# To clean household data from Niger
# Based on R-Script for Benin (as of 06.09.2022)
# Author: L. Missbach (missbach@mcc-berlin.net)

# Load Data ####

data_0.0   <- read_dta("../0_Data/1_Household Data/2_Niger/1_Data_Raw/ehcvm_conso_ner2018.dta") # Consumption

data_0.3   <- read_dta("../0_Data/1_Household Data/2_Niger/1_Data_Raw/ehcvm_ponderations_ner2018.dta") # HH-Weights

data_0.5   <- read_dta("../0_Data/1_Household Data/2_Niger/1_Data_Raw/s00_me_ner2018.dta") # Control Information
# data_0.6 <- read_dta("../0_Data/1_Household Data/2_Niger/1_Data_Raw/s00a_co_ner2018.dta")
# data_0.7 <- read_dta("../0_Data/1_Household Data/2_Niger/1_Data_Raw/s00b_co_ner2018.dta")

data_1.1   <- read_dta("../0_Data/1_Household Data/2_Niger/1_Data_Raw/s01_me_ner2018.dta") # Household Socio-Demographic Characteristics
# data_1.2 <- read_dta("../0_Data/1_Household Data/2_Niger/1_Data_Raw/s01_co_ner2018.dta")
data_2.1   <- read_dta("../0_Data/1_Household Data/2_Niger/1_Data_Raw/s02_me_ner2018.dta") # Education
# data_2.2 <- read_dta("../0_Data/1_Household Data/2_Niger/1_Data_Raw/s02_co_ner2018.dta")
data_3.1   <- read_dta("../0_Data/1_Household Data/2_Niger/1_Data_Raw/s03_me_ner2018.dta") # General Health
# data_3.2 <- read_dta("../0_Data/1_Household Data/2_Niger/1_Data_Raw/s03_co_ner2018.dta")
data_4.1   <- read_dta("../0_Data/1_Household Data/2_Niger/1_Data_Raw/s04_me_ner2018.dta") # Employment
# data_4.2 <- read_dta("../0_Data/1_Household Data/2_Niger/1_Data_Raw/s04_co_ner2018.dta")
data_5.1   <- read_dta("../0_Data/1_Household Data/2_Niger/1_Data_Raw/s05_me_ner2018.dta") # Nonjob Revenues
# data_5.2 <- read_dta("../0_Data/1_Household Data/2_Niger/1_Data_Raw/s05_co_ner2018.dta")

data_7.1   <- read_dta("../0_Data/1_Household Data/2_Niger/1_Data_Raw/s07a1_me_ner2018.dta") # Food outside the household
data_7.2   <- read_dta("../0_Data/1_Household Data/2_Niger/1_Data_Raw/s07a2_me_ner2018.dta") # Food outside the household
data_7.3   <- read_dta("../0_Data/1_Household Data/2_Niger/1_Data_Raw/s07b_me_ner2018.dta") # Food within the household

# data_8.1 <- read_dta("../0_Data/1_Household Data/2_Niger/1_Data_Raw/s08a_me_ner2018.dta") # Food security
# data_8.2 <- read_dta("../0_Data/1_Household Data/2_Niger/1_Data_Raw/s08b1_me_ner2018.dta")# Food security
# data_8.3 <- read_dta("../0_Data/1_Household Data/2_Niger/1_Data_Raw/s08b2_me_ner2018.dta")# Food security

data_9.1   <- read_dta("../0_Data/1_Household Data/2_Niger/1_Data_Raw/s09a_me_ner2018.dta") # Nonfood 12 months
data_9.2   <- read_dta("../0_Data/1_Household Data/2_Niger/1_Data_Raw/s09b_me_ner2018.dta") # Nonfood 7 days
data_9.3   <- read_dta("../0_Data/1_Household Data/2_Niger/1_Data_Raw/s09c_me_ner2018.dta") # Nonfood 30 days
data_9.4   <- read_dta("../0_Data/1_Household Data/2_Niger/1_Data_Raw/s09d_me_ner2018.dta") # Nonfood 3 months
data_9.5   <- read_dta("../0_Data/1_Household Data/2_Niger/1_Data_Raw/s09e_me_ner2018.dta") # Nonfood 6 months
data_9.6   <- read_dta("../0_Data/1_Household Data/2_Niger/1_Data_Raw/s09f_me_ner2018.dta") # Nonfood 12 months

data_11.1  <- read_dta("../0_Data/1_Household Data/2_Niger/1_Data_Raw/s11_me_ner2018.dta") # Housing
data_12.1  <- read_dta("../0_Data/1_Household Data/2_Niger/1_Data_Raw/s12_me_ner2018.dta") # Assets

data_13.1  <- read_dta("../0_Data/1_Household Data/2_Niger/1_Data_Raw/s13a_1_me_ner2018.dta") # Transfers received (remittances)
data_13.2  <- read_dta("../0_Data/1_Household Data/2_Niger/1_Data_Raw/s13a_2_me_ner2018.dta") # Transfers sent (remittances)
data_15.1  <- read_dta("../0_Data/1_Household Data/2_Niger/1_Data_Raw/s15_me_ner2018.dta") # Safety nets
...
data_11.1.1 <- data_11.1 %>%
  ...
  mutate(electricity.access = ifelse(s11q34 == 4 & !is.na(s11q34),0,1))%>%
  mutate(s11q27a = ifelse(is.na(s11q27a),17,s11q27a))%>%
                                                      ...
                                                      ifelse(s11q53__5 == 1, "Electricity",
                                                             ifelse(s11q53__6 == 1, "Petrol",
                                                                    ifelse(s11q53__7 == 1, "Aninmal Waste",
                                                                           ifelse(s11q53__8 == 1, "Other", "Other")))))))))%>%
  select(hh_id, lighting_fuel, Cooking_Fuel, toilet, water, electricity.access)%>%
  mutate(toilet = ifelse(is.na(toilet),12,toilet))%>%
  mutate(Cooking_Fuel  = ifelse(is.na(Cooking_Fuel),"Other", Cooking_Fuel),
         lighting_fuel = ifelse(is.na(lighting_fuel),7,lighting_fuel))

Cooking.Code <- distinct(data_11.1.1, Cooking_Fuel)%>%
  mutate(cooking_fuel = 1:n())%>%
  write_csv(., "../0_Data/1_Household Data/2_Niger/2_Codes/Cooking.Code.csv")
...
write_csv(household_information, "../0_Data/1_Household Data/2_Niger/1_Data_Clean/household_information_Niger.csv")
...
write_csv(expenditures_df_2, "../0_Data/1_Household Data/2_Niger/1_Data_Clean/expenditures_items_Niger.csv")
...
write_csv(data_12.1.1, "../0_Data/1_Household Data/2_Niger/1_Data_Clean/appliances_0_1_Niger.csv")

# Codes ####
Item.Code.All <- distinct(data_0.0, codpr)%>%
  arrange(codpr)%>%
  rename(item_code = codpr)
...
Item.Code.G   <- stack(attr(data_7.3$s07bq01, 'labels'))


Item.Joint.1 <- bind_rows(Item.Code.B, Item.Code.C, Item.Code.D, Item.Code.E, Item.Code.F, Item.Code.G)%>%
  rename(item_code = values, item_name = ind)%>%
  right_join(Item.Code.All)%>%
...
# write.xlsx(Item.Joint.1, "../0_Data/1_Household Data/2_Niger/3_Matching_Tables/Item_Code_Description_Niger.xlsx")
...
Education.Code <- stack(attr(data_2.1$s02q29, 'labels'))%>%
  ...
  write_csv(., "../0_Data/1_Household Data/2_Niger/2_Codes/Education.Code.csv")
Province.Code <- stack(attr(data_0.5$s00q01, 'labels'))%>%
  rename(province = values, Province = ind)%>%
  write_csv(., "../0_Data/1_Household Data/2_Niger/2_Codes/Province.Code.csv")
District.Code <- stack(attr(data_0.5$s00q02, 'labels'))%>%
  rename(district = values, District = ind)%>%
  write_csv(., "../0_Data/1_Household Data/2_Niger/2_Codes/District.Code.csv")
...
Religion.Code <- stack(attr(data_1.1$s01q14, 'labels'))%>%
  ...
  write_csv(., "../0_Data/1_Household Data/2_Niger/2_Codes/Religion.Code.csv")
Lighting.Code <- stack(attr(data_11.1$s11q38, 'labels'))%>%
  rename(lighting_fuel = values, Lighting_Fuel = ind)%>%
  write_csv(., "../0_Data/1_Household Data/2_Niger/2_Codes/Lighting.Code.csv")
Toilet.Code <- stack(attr(data_11.1$s11q55, 'labels'))%>%
  rename(toilet = values, TLT = ind)%>%
  write_csv(., "../0_Data/1_Household Data/2_Niger/2_Codes/Toilet.Code.csv")
...
write_csv(Water.Code, "../0_Data/1_Household Data/2_Niger/2_Codes/Water.Code.csv")

Industry.Code <- stack(attr(data_4.1$s04q30c, 'labels'))%>%
  rename(ind_hhh = values, Industry = ind)%>%
  write_csv(., "../0_Data/1_Household Data/2_Niger/2_Codes/Industry.Code.csv")
