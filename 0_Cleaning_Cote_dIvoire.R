...
# To clean household data from Cote d'Ivoire
# Based on R-Script for Benin (as of 06.09.2022)
# Author: L. Missbach (missbach@mcc-berlin.net)

# Load Data ####

data_0.0   <- read_dta("../0_Data/1_Household Data/2_Cote dIvoire/1_Data_Raw/ehcvm_conso_civ2018.dta") # Consumption

data_0.3   <- read_dta("../0_Data/1_Household Data/2_Cote dIvoire/1_Data_Raw/ehcvm_ponderations_civ2018.dta") # HH-Weights

data_0.5   <- read_dta("../0_Data/1_Household Data/2_Cote dIvoire/1_Data_Raw/s00_me_civ2018.dta") # Control Information
# data_0.6 <- read_dta("../0_Data/1_Household Data/2_Cote dIvoire/1_Data_Raw/s00a_co_civ2018.dta")
# data_0.7 <- read_dta("../0_Data/1_Household Data/2_Cote dIvoire/1_Data_Raw/s00b_co_civ2018.dta")

data_1.1   <- read_dta("../0_Data/1_Household Data/2_Cote dIvoire/1_Data_Raw/s01_me_civ2018.dta") # Household Socio-Demographic Characteristics
# data_1.2 <- read_dta("../0_Data/1_Household Data/2_Cote dIvoire/1_Data_Raw/s01_co_civ2018.dta")
data_2.1   <- read_dta("../0_Data/1_Household Data/2_Cote dIvoire/1_Data_Raw/s02_me_civ2018.dta") # Education
# data_2.2 <- read_dta("../0_Data/1_Household Data/2_Cote dIvoire/1_Data_Raw/s02_co_civ2018.dta")
data_3.1   <- read_dta("../0_Data/1_Household Data/2_Cote dIvoire/1_Data_Raw/s03_me_civ2018.dta") # General Health
# data_3.2 <- read_dta("../0_Data/1_Household Data/2_Cote dIvoire/1_Data_Raw/s03_co_civ2018.dta")
data_4.1   <- read_dta("../0_Data/1_Household Data/2_Cote dIvoire/1_Data_Raw/s04_me_civ2018.dta") # Employment
# data_4.2 <- read_dta("../0_Data/1_Household Data/2_Cote dIvoire/1_Data_Raw/s04_co_civ2018.dta")
data_5.1   <- read_dta("../0_Data/1_Household Data/2_Cote dIvoire/1_Data_Raw/s05_me_civ2018.dta") # Nonjob Revenues
# data_5.2 <- read_dta("../0_Data/1_Household Data/2_Cote dIvoire/1_Data_Raw/s05_co_civ2018.dta")

data_7.1   <- read_dta("../0_Data/1_Household Data/2_Cote dIvoire/1_Data_Raw/s07a1_me_civ2018.dta") # Food outside the household
data_7.2   <- read_dta("../0_Data/1_Household Data/2_Cote dIvoire/1_Data_Raw/s07a2_me_civ2018.dta") # Food outside the household
data_7.3   <- read_dta("../0_Data/1_Household Data/2_Cote dIvoire/1_Data_Raw/s07b_me_civ2018.dta") # Food within the household

# data_8.1 <- read_dta("../0_Data/1_Household Data/2_Cote dIvoire/1_Data_Raw/s08a_me_civ2018.dta") # Food security
# data_8.2 <- read_dta("../0_Data/1_Household Data/2_Cote dIvoire/1_Data_Raw/s08b1_me_civ2018.dta")# Food security
# data_8.3 <- read_dta("../0_Data/1_Household Data/2_Cote dIvoire/1_Data_Raw/s08b2_me_civ2018.dta")# Food security

data_9.1   <- read_dta("../0_Data/1_Household Data/2_Cote dIvoire/1_Data_Raw/s09a_me_civ2018.dta") # Nonfood 12 months
data_9.2   <- read_dta("../0_Data/1_Household Data/2_Cote dIvoire/1_Data_Raw/s09b_me_civ2018.dta") # Nonfood 7 days
data_9.3   <- read_dta("../0_Data/1_Household Data/2_Cote dIvoire/1_Data_Raw/s09c_me_civ2018.dta") # Nonfood 30 days
data_9.4   <- read_dta("../0_Data/1_Household Data/2_Cote dIvoire/1_Data_Raw/s09d_me_civ2018.dta") # Nonfood 3 months
data_9.5   <- read_dta("../0_Data/1_Household Data/2_Cote dIvoire/1_Data_Raw/s09e_me_civ2018.dta") # Nonfood 6 months
data_9.6   <- read_dta("../0_Data/1_Household Data/2_Cote dIvoire/1_Data_Raw/s09f_me_civ2018.dta") # Nonfood 12 months

data_11.1  <- read_dta("../0_Data/1_Household Data/2_Cote dIvoire/1_Data_Raw/s11_me_civ2018.dta") # Housing
data_12.1  <- read_dta("../0_Data/1_Household Data/2_Cote dIvoire/1_Data_Raw/s12_me_civ2018.dta") # Assets

data_13.1  <- read_dta("../0_Data/1_Household Data/2_Cote dIvoire/1_Data_Raw/s13a_1_me_civ2018.dta") # Transfers received (remittances)
data_13.2  <- read_dta("../0_Data/1_Household Data/2_Cote dIvoire/1_Data_Raw/s13a_2_me_civ2018.dta") # Transfers sent (remittances)
data_15.1  <- read_dta("../0_Data/1_Household Data/2_Cote dIvoire/1_Data_Raw/s15_me_civ2018.dta") # Safety nets
...
Cooking.Code <- distinct(data_11.1.1, Cooking_Fuel)%>%
  ...
  write_csv(., "../0_Data/1_Household Data/2_Cote dIvoire/2_Codes/Cooking.Code.csv")
...
write_csv(household_information, "../0_Data/1_Household Data/2_Cote dIvoire/1_Data_Clean/household_information_Cote dIvoire.csv")
...
write_csv(expenditures_df_2, "../0_Data/1_Household Data/2_Cote dIvoire/1_Data_Clean/expenditures_items_Cote dIvoire.csv")
...
write_csv(data_12.1.1, "../0_Data/1_Household Data/2_Cote dIvoire/1_Data_Clean/appliances_0_1_Cote dIvoire.csv")
...
# write.xlsx(Item.Joint.1, "../0_Data/1_Household Data/2_Cote dIvoire/3_Matching_Tables/Item_Code_Description_Cote dIvoire.xlsx")
...
Education.Code <- stack(attr(data_2.1$s02q29, 'labels'))%>%
  ...
  write_csv(., "../0_Data/1_Household Data/2_Cote dIvoire/2_Codes/Education.Code.csv")
...
Gender.Code <- stack(attr(data_1.1$s01q01, 'labels'))%>%
  ...
  write_csv(., "../0_Data/1_Household Data/2_Cote dIvoire/2_Codes/Gender.Code.csv")
Ethnicity.Code <- stack(attr(data_1.1$s01q16, 'labels'))%>%
  rename(ethnicity = values, Ethnicity = ind)%>%
  write_csv(., "../0_Data/1_Household Data/2_Cote dIvoire/2_Codes/Ethnicity.Code.csv")
Nationality.Code <- stack(attr(data_1.1$s01q15, 'labels'))%>%
  rename(nationality = values, Nationality = ind)%>%
  write_csv(., "../0_Data/1_Household Data/2_Cote dIvoire/2_Codes/Nationality.Code.csv")
Religion.Code <- stack(attr(data_1.1$s01q14, 'labels'))%>%
  rename(religion = values, Religion = ind)%>%
  write_csv(., "../0_Data/1_Household Data/2_Cote dIvoire/2_Codes/Religion.Code.csv")
Lighting.Code <- stack(attr(data_11.1$s11q38, 'labels'))%>%
  rename(lighting_fuel = values, Lighting_Fuel = ind)%>%
  write_csv(., "../0_Data/1_Household Data/2_Cote dIvoire/2_Codes/Lighting.Code.csv")
Toilet.Code <- stack(attr(data_11.1$s11q55, 'labels'))%>%
  rename(toilet = values, TLT = ind)%>%
  write_csv(., "../0_Data/1_Household Data/2_Cote dIvoire/2_Codes/Toilet.Code.csv")
